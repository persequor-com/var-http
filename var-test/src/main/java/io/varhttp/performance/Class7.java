...
public class Class7 {
	...
	@Controller(path = "/class7/controller1/{muh}", httpMethods = {HttpMethod.GET})
	...
	@Controller(path = "/class7/controller2/{muh}", httpMethods = {HttpMethod.GET})
