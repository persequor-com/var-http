...
public class Class2 {
	...
	@Inject
	public Class2(FilterCatcher filterCatcher) {
		this.filterCatcher = filterCatcher;
	}

	@Controller(path = "/class2/controller1/{muh}", httpMethods = {HttpMethod.GET})
	...
	@Controller(path = "/class2/controller2/{muh}", httpMethods = {HttpMethod.GET})
