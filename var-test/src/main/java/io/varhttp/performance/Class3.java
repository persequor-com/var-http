...
public class Class3 {
	...
	@Controller(path = "/class3/controller1/{muh}", httpMethods = {HttpMethod.GET})
	...
	@Controller(path = "/class3/controller2/{muh}", httpMethods = {HttpMethod.GET})
