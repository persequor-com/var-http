...
public class Class5 {
	...
	@Controller(path = "/class5/controller1/{muh}", httpMethods = {HttpMethod.GET})
	...
	@Controller(path = "/class5/controller2/{muh}", httpMethods = {HttpMethod.GET})
