...
public class Class2 {
	...
	@Controller(path = "/class2/controller1")
	public String c1() {
		filterCatcher.add("Muh was called");
		return "muh";
	}

	@Controller(path = "/class2/controller2")
	...
	@Controller(path = "/class2/controller3")
	public String c3() {
		filterCatcher.add("Muh was called");
		return "muh";
	}

	@Controller(path = "/class2/controller4")
	public String c4() {
		filterCatcher.add("Muh was called");
		return "muh";
	}

	@Controller(path = "/class2/controller5")
	public String c5() {
		filterCatcher.add("Muh was called");
		return "muh";
	}
