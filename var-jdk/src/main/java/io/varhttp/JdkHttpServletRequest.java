...
public class JdkHttpServletRequest implements HttpServletRequest {
	...
	public JdkHttpServletRequest(HttpExchange ex, Map<String, String[]> postData, ServletInputStream is, ServletContext context, VarConfig config) {
		this.ex = ex;
